...
fun RepoView(
    ...
    var installedModules by remember { mutableStateOf<List<Pair<InstalledModule?, RemoteModule>>>(emptyList()) }
    var refreshTick by remember { mutableStateOf(0) }

    LaunchedEffect(refreshTick) {
        installedModules = repositoryManager.getInstalledModules()
